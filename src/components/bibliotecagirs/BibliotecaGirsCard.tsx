    ...
    return (
        ...
        >
            ...
            <div className="p-6 flex flex-col flex-grow">
                ...
                <a
                    href={href}
                    className="w-max inline-flex items-center justify-center px-4 py-2 bg-[#003d52] hover:bg-[#002f40] transition-colors text-white font-medium rounded-lg text-sm group"
                >
                    Ver más
